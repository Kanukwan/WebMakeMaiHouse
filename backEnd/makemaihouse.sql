...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2017 at 05:19 PM
...
--
CREATE DATABASE IF NOT EXISTS `makemaihouse` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `makemaihouse`;
...
CREATE TABLE `image` (
  ...
  `img_name` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
